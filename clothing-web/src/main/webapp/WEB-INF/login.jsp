...
<%--<div class="header"></div>--%> <%-- TODO(背景图)--%>
<div class=""></div>
<%--<div class="loginWraper">--%> <%-- TODO(背景图)--%>
<div class="">
    <div id="loginform" class="loginBox">
        <form action="index" class="form form-horizontal" method="post">
...
<%--<div class="footer">Copyright<a>@@@</a></div>--%>
<div class="">Copyright<a>@@@</a></div><%-- TODO(背景图)--%>
