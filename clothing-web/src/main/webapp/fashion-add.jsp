...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add"  method="post">
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-1" style="text-align: right"><span class="c-red">*</span>款式名称：</label>
            <div class="formControls col-xs-8 col-sm-5">
                <input type="text" class="input-text" value=""  id="fashionName" name="fashionName" placeholder="请输入款式">
            </div>
        </div>
    ...
    window.test = function () {
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                {
                    layer.msg('该款式已经存在，不能添加!',{icon:1,time:1000});
                    return false;
                }
                var index = parent.layer.getFrameIndex(window.name);
