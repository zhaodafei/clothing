...
public class ImageTool {
    ...
    public static void outputImage(HttpSession session,
     ...
     * @param pSize
     */
    public static void imagePut(HttpSession session,
                                OutputStream out,
                                int pWidth,
                                int pHeigth,
                                int pSize) throws IOException {
        BufferedImage image = new BufferedImage(pWidth, pHeigth, BufferedImage.TYPE_INT_RGB);
        Graphics g = image.getGraphics();

        g.setColor(getRandColor(200, 250));
        g.fillRect(0, 0, pHeigth, 250);
    ...
    public static void imagePutOneColor(HttpSession session,
                                        OutputStream out,
                                        int pWidth,
                                        int pHeight,
                                        int pSize) throws IOException {
    ...
    public static void outputImage(String sessionName,
                                   HttpSession session,
                                   HttpServletResponse response) throws IOException {
        BufferedImage image = new BufferedImage(60, 20, BufferedImage.TYPE_INT_RGB);
        Graphics g = image.getGraphics();
