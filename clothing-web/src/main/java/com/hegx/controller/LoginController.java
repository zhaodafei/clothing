...
public class LoginController {
    ...
    public void checkCode(UserEntityDto userEntityDto, HttpServletRequest request, HttpServletResponse response) throws IOException {
        OutputStream out = response.getOutputStream();

        if (!userEntityDto.getCheckCode().equals("")) { // 验证码登录的验证
            String checkCode = (String) request.getSession().getAttribute("validCode");
